...
func TestLoginUserInvalidErrorInterface(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"message": "invalid restclient response when trying to login user", "status": "404", "error": "not_found"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		ReqBody:      `{"email":"email@gmail.com","password":"the-password"}`,
		RespHTTPCode: http.StatusOK,
		RespBody:     `{"id": 1, "first_name": "test", "last_name": "test", "email": "test.ba@gmail.com"}`,
	})
	...
	assert.EqualValues(t, "test.ba@gmail.com", user.Email)
}
